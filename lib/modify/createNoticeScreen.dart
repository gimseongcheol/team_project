...
class CreateNoticeScreen extends StatefulWidget {
  @override
  _CreateNostScreenState createState() => _CreateNostScreenState();
}

class _CreateNostScreenState extends State<CreateNoticeScreen> {

  void _addImage() {
    // 이미지 추가 기능 구현 => 회원가입할때 사진들고 오는 방식 사용하자
    print('이미지 추가');
  }
